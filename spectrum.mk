...
$(call inherit-product-if-exists, vendor/lge/spectrum/spectrum-vendor.mk)

PRODUCT_TAGS += dalvik.gc.type-precise
$(call inherit-product, frameworks/base/build/phone-xhdpi-1024-dalvik-heap.mk)

DEVICE_PACKAGE_OVERLAYS += device/lge/spectrum/overlay
...
PRODUCT_NAME := full_spectrum
PRODUCT_DEVICE := spectrum
PRODUCT_MODEL := LG-spectrum
